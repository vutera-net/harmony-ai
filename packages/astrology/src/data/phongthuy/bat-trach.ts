...
export const CUNG_MENH_DATA: CungMenhData[] = [
  { name: 'Khảm', number: 1, nhom: 'dong', nguHanh: 'Thủy', description: 'Cung Khảm - Bắc' },
  { name: 'Khôn', number: 2, nhom: 'tay', nguHanh: 'Thổ', description: 'Cung Khôn - Tây Nam' },
  { name: 'Chấn', number: 3, nhom: 'dong', nguHanh: 'Mộc', description: 'Cung Chấn - Đông' },
  { name: 'Tốn', number: 4, nhom: 'dong', nguHanh: 'Mộc', description: 'Cung Tốn - Đông Nam' },
  // 5 maps to Khôn (nữ) or Cấn (nam) depending on gender
  { name: 'Càn', number: 6, nhom: 'tay', nguHanh: 'Kim', description: 'Cung Càn - Tây Bắc' },
  { name: 'Đoài', number: 7, nhom: 'tay', nguHanh: 'Kim', description: 'Cung Đoài - Tây' },
  { name: 'Cấn', number: 8, nhom: 'tay', nguHanh: 'Thổ', description: 'Cung Cấn - Đông Bắc' },
...
const BAT_TRACH_DIRECTIONS: Record<CungMenh, DirectionKey[]> = {
  Khảm: ['DN', 'D', 'N', 'B', 'TB', 'DB', 'TN', 'T'],
  Khôn: ['DB', 'T', 'TB', 'TN', 'D', 'N', 'B', 'DN'],
  Chấn: ['N', 'DN', 'D', 'D', 'TN', 'TB', 'T', 'DB'],
  Tốn: ['B', 'N', 'DN', 'DN', 'T', 'TN', 'DB', 'TB'],
  Càn: ['T', 'TB', 'TN', 'TB', 'DN', 'D', 'N', 'B'],
  Đoài: ['TB', 'DB', 'TN', 'T', 'D', 'DN', 'N', 'B'],
  Cấn: ['TN', 'T', 'TB', 'DB', 'B', 'DN', 'D', 'N'],
...
export function getMenhNhom(cungMenh: CungMenh): MenhNhom {
  const dongTuMenh: CungMenh[] = ['Khảm', 'Chấn', 'Tốn', 'Ly']
