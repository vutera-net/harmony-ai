...
import { Compass, Info, Sparkles, MapPin, CheckCircle, XCircle, RefreshCw } from "lucide-react";
...
export default function BatTrach() {
  ...
  const handleCalculate = useCallback(async () => {
    if (typeof year === "number" && year >= 1900 && year <= 2030) {
      ...
      try {
        const res = await fetch("/api/bat-trach/analyze", {
          method: "POST",
