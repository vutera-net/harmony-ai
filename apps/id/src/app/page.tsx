    ...
    <div className="min-h-screen bg-gradient-to-br from-slate-900 via-slate-800 to-slate-900 flex items-center justify-center">
      <div className="max-w-lg w-full mx-4">
        ...
        <div className="text-center mb-12">
          ...
          <p className="text-slate-300">Identity & Authentication Hub</p>
        ...
        <div className="bg-white rounded-xl shadow-2xl p-8 space-y-4">
          <div className="text-center mb-6">
            ...
            <p className="text-slate-600 text-sm mt-2">
              Manage your Harmony AI account
            </p>
          </div>
        ...
        <div className="mt-12 grid grid-cols-2 gap-4">
          <div className="bg-slate-800 rounded-lg p-4 text-center">
            ...
            <p className="text-slate-300 text-sm font-medium">Secure Auth</p>
          </div>
          <div className="bg-slate-800 rounded-lg p-4 text-center">
            <div className="text-2xl mb-2">🌐</div>
          ...
          <div className="bg-slate-800 rounded-lg p-4 text-center">
            <div className="text-2xl mb-2">✨</div>
            <p className="text-slate-300 text-sm font-medium">Birth Data</p>
          </div>
        </div>
        ...
        <div className="mt-12 text-center text-slate-400 text-xs">
          <p>
            Part of the Harmony AI Ecosystem
          </p>
          <p className="mt-2">
